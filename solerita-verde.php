		...
		<div class="container">
			<ul class="productos-imagen">
				<li class="productos-imagen-description">
					<img src="imagenes/Chicos/IMG_2792.jpg" alt="solerita frente">
				</li>
				<li class="productos-imagen-description">
					<img src="imagenes/Chicos/IMG_2793.jpg" alt="detalle del tejido">
				</li>
				<li class="productos-imagen-description">
					<img src="imagenes/Chicos/IMG_2794.jpg" alt="solerita frente detalle tejido">
				</li>
			</ul>
