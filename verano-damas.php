	...
	<section class="damas">
		<div class="container">
			<ul class="damas-description">
				...
				<li class="damas-description-list">
					<div class="damas-img">
						<img src="imagenes/Temporada/Verano/Damas/IMG_2620.jpg" alt="remeron color rosa">
					</div>
					<div class="damas-text">	
						<h3>Remeron</h3>
						<p class="p-description">Tejido al crochet, hilo de algodón.</p>
				...
				<li class="damas-description-list">
					<div class="damas-img">
						<img src="imagenes/Temporada/Verano/Damas/IMG_2623.jpg" alt="remera cruzada verde">
					</div>
					<div class="damas-text">	
				...
				<li class="damas-description-list">
					<div class="damas-img">							
						<img src="imagenes/Temporada/Verano/Damas/IMG_4621.jpg" alt="chaleco verde musgo">
					</div>
					<div class="damas-text">		
						<h3>Chaleco</h3>
				...
				<li class="damas-description-list">
					<div class="damas-img">							
						<img src="imagenes/Temporada/Verano/Damas/IMG_2626.jpg" alt="chaleco violeta">
					</div>
					<div class="damas-text">		
						<h3>Chaleco</h3>
						<p class="p-description">Tejido al crochet, hilo de algodón.</p>
				...
				<li class="damas-description-list">
					<div class="damas-img">
						<img src="imagenes/Temporada/Verano/Damas/IMG_2636.jpg" alt="poncho corto verde">
					</div>
					<div class="damas-text">
						<h3>Poncho Corto</h3>
