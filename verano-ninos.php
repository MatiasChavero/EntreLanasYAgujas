	...
	<section class="niños">
		<div class="container">
			<ul class="niños-description">
				...
				<li class="niños-description-list">
					<div class="niños-img">
						<img src="imagenes/Temporada/Verano/Ninos/IMG_2786.jpg" alt="chaleco rosa y blanco">
					</div>
					<div class="niños-text">
						<h3>Chaleco</h3>
				...
				<li class="niños-description-list">
					<div class="niños-img">
						<img src="imagenes/Temporada/Verano/Ninos/IMG_2776.jpg" alt="camperita multicolor">
					</div>
					<div class="niños-text">
						<h3>Camperita</h3>
						<p class="p-description">Tejida al crochet, de hilo.</p>
				...
				<li class="niños-description-list">
					<div class="niños-img">
						<img src="imagenes/Temporada/Verano/Ninos/IMG_2798.jpg" alt="pollerita multicolor">
					</div>
					<div class="niños-text">
						<h3>Pollerita</h3>
				...
				<li class="niños-description-list">
					<div class="niños-img">
						<img src="imagenes/Temporada/Verano/Ninos/IMG_2808.jpg" alt="remerita blanca">
					</div>
					<div class="niños-text">
						<h3>Remerita</h3>
